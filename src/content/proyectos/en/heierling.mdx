...
Heierling GmbH makes and sells made-to-measure ski boots in Davos. The module uses it as an **academic case study**: the brief was to design an inventory system for a business of that kind from scratch, not to audit the one the company actually runs.
