...
El análisis completo, tal y como lo entregué en el módulo *Internet Technology and Security* (CEAC4011), está disponible en PDF: [Análisis Integral de Seguridad Web](/docs/memoria-seguridad-web-internet-technology-security.pdf) — 10 páginas, abril de 2026.
